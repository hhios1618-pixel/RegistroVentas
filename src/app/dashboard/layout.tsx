...
const ROLE_CAPS: Record<Role, Cap[]> = {
  admin: [
    'view:kpis','view:logistica','view:sales-report','view:vendedores','view:returns',
    'view:promotores:registro','view:promotores:resumen','view:asistencia',
    'view:users-admin','view:playbook'
  ],
  promotor: ['view:promotores:registro', 'view:promotores:resumen'],
  coordinador: ['view:kpis','view:logistica','view:asistencia','view:playbook'],
  lider: ['view:kpis','view:vendedores','view:promotores:resumen','view:asistencia','view:playbook'],
  asesor: ['view:sales-report','view:playbook'],
  unknown: [],
};
...
const NavLink: FC<{ link: { cap: Cap; href: string; icon: ReactNode; label: string; shortcut?: string }; isActive?: boolean }> =
({ link, isActive = false }) => (
  <Link
    href={link.href}
  ...
  const navSections = [
    {
      ...
      links: [
        ...
        { cap: 'view:vendedores', href: '/dashboard/vendedores', icon: <IconResumen className="w-5 h-5" />, label: 'Resumen Asesores', shortcut: '7' },
        // 🔵 NUEVO: Panel/Resumen de Promotores
        { cap: 'view:promotores:resumen', href: '/dashboard/promotores', icon: <IconResumen className="w-5 h-5" />, label: 'Resumen Promotores' },
        { cap: 'view:asistencia', href: '/dashboard/admin/resumen', icon: <IconAsistencia className="w-5 h-5" />, label: 'Reporte de Asistencia', shortcut: 'R' },
      ],
    },
    {
      ...
      links: [
        ...
        { cap: 'view:promotores:registro', href: '/dashboard/asesores/registro', icon: <IconRegistro className="w-5 h-5" />, label: 'Registro Ventas (Asesores)', shortcut: '6' },
        // 🔵 NUEVO: Registro de Promotores
        { cap: 'view:promotores:registro', href: '/dashboard/promotores/registro', icon: <IconRegistro className="w-5 h-5" />, label: 'Registro Promotores' },
        { cap: 'view:returns', href: '/dashboard/asesores/devoluciones', icon: <IconReturn className="w-5 h-5" />, label: 'Devoluciones', shortcut: '4' },
          ...
          return (
            <div key={section.title} className="pt-2">
              ...
              {accessibleLinks.map((link) => (
                <NavLink key={link.href} link={link as any} />
              ))}
            </div>
          );
        })}
...
// --- ICONOS ---
const IconTruck: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <rect x="1" y="3" width="15" height="13" /><polygon points="16 8 20 8 23 11 23 16 16 16 16 8" /><circle cx="5.5" cy="18.5" r="2.5" /><circle cx="18.5" cy="18.5" r="2.5" />
  </svg>
);
const IconRegistro: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48" />
  </svg>
);
const IconResumen: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /><polyline points="10 9 9 9 8 9" />
  </svg>
);
const IconAsistencia: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const IconSalesReport: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M8 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-3" /><rect x="8" y="1" width="8" height="4" rx="1" ry="1" /><line x1="12" y1="16" x2="12" y2="12" /><line x1="16" y1="16" x2="16" y2="9" /><line x1="8" y1="16" x2="8" y2="14" />
  </svg>
);
const IconReturn: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <polyline points="9 14 4 9 9 4" /><path d="M20 20v-7a4 4 0 0 0-4-4H4" />
  </svg>
);
const IconPlaybook: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" /><path d="M6.5 2H20v15H6.5A2.5 2.5 0 0 1 4 14.5v-10A2.5 2.5 0 0 1 6.5 2z" />
  </svg>
);
const IconUsersAdmin: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
