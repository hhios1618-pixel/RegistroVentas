...
const ROLE_CAPS: Record<Role, Cap[]> = {
  ...
  asesor: [
    'view:resumen-asesores','view:registro-asesores','view:asistencia','view:playbook'
  ],
  promotor: [
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const userRole = useMemo(() => normalizeRole(me?.role), [me?.role]); // <- usa role ya normalizado
